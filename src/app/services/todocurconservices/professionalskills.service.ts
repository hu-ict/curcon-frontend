...
export class ProfessionalskillsService {
	...
	getProfessionalskills() {
		return this.http.get<curconnamespace.CurconNameSpace.>(myGlobals.baseUrl+'professionalskills/', { headers : this.headers })
		.pipe( tap( res => console.log(res)) );
	}

	getProfessionalskillsByObject(obj) {
		return this.http.get<curconnamespace.CurconNameSpace.>(obj.href, { headers : this.headers })
		.pipe( tap( res => console.log(res)) );
	}

	getProfessionalskillsTypes() {
		return this.http.get<curconnamespace.CurconNameSpace.>(myGlobals.baseUrl+'professionalskills/types', { headers : this.headers })
		.pipe( tap( res => console.log(res)) );
	}


	getProfessionalskillId(skillid, niv) {
		return this.http.get<curconnamespace.CurconNameSpace.>(myGlobals.baseUrl+'professionalskills/skill/' + skillid + '/niveaus/' + niv, { headers : this.headers })
		.pipe( tap( res => console.log(res)) );
	}
