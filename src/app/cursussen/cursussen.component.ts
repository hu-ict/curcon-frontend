...
export class CursussenComponent implements OnInit {
   ...
   initializeToetsModal(toets) {
      console.log('initializeBeoordelingselementModal(toets)');
      this.toetsModal.show();
      if (toets.id === undefined) {
         this.toetsForm = {
            naam: '',
         ...
         this.toetsForm = {
            ...
            omschrijving: toets.omschrijving,
   ...
   initializeBeoordelingselementModal(toets, beoordelingselement) {
      console.log(beoordelingselement);
      this.beoordelingselementModal.show();
      this.loading = true;
      this.toetsEdit = toets;
      if (beoordelingselement.id === undefined) {
